...
SELECT *, (CAST(rollingpeoplevacinated AS FLOAT) / CAST(population AS FLOAT)) * 100 AS vaccination_percentage
FROM PopsVac;
...
SET vaccination_percentage = (RollingPeopleVaccinated / Population) * 100;
